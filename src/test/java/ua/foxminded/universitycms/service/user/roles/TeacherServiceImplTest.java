...
class TeacherServiceImplTest {
  ...
  void addTeacherShouldWorkCorrectlyIfTeacherEntityCorrect() {
    ...
    teacherServiceImpl.addTeacher(newTeacher);
  ...
  void getTeacherByIdShouldReturnCorrectTeacherIfExists() {
    ...
    Optional<Teacher> result = teacherServiceImpl.getTeacherById(teacherId);
  ...
  void getTeacherByIdShouldReturnEmptyIfTeacherDoesNotExist() {
    ...
    Optional<Teacher> result = teacherServiceImpl.getTeacherById(nonExistentId);
  ...
  void getAllTeachersWithPaginationShouldReturnCorrectData() {
    ...
    List<Teacher> returnedTeachers = teacherServiceImpl.getAllTeachers(1, 2);
  ...
  void updateTeacherShouldCallSaveMethod() {
    ...
    teacherServiceImpl.updateTeacher(teacherToUpdate);
  ...
  void deleteTeacherShouldWorkCorrectlyIfTeacherExists() {
    ...
    boolean result = teacherServiceImpl.deleteTeacher(teacherId);
