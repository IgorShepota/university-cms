...
//
//    groupServiceImpl.addGroup(newGroup);
//
...
//
//    Optional<Group> result = groupServiceImpl.getGroupById(groupId);
//
...
//
//    Optional<Group> result = groupServiceImpl.getGroupById(nonExistentId);
//
...
//
//    List<Group> returnedGroups = groupServiceImpl.getAllGroups(1, 2);
//
...
//
//    groupServiceImpl.updateGroup(groupToUpdate);
//
...
//
//    boolean result = groupServiceImpl.deleteGroup(groupId);
//
